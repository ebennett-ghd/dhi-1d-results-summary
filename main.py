...
def parse_arguments() -> Tuple[
    ...
    if parsed_args.output_filename is not None:
    ...
    try:
        ...
        return file_paths, critical_durations, output_directory, output_filename, from_crs, parsed_args.no_round_outputs
...
def main(argv):
    ...
    description = """
    DHI 1D points - extraction tool - log file. This log file is generated by the DHI 1D points extraction tool version 1.0.0 which was last updated on 2021-11-23.
